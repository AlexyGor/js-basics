...
const prodWithPhoto = products.filter(item => "photos" in item && item.photos.length > 0);
console.log(prodWithPhoto);
const sortFromMinPrice = products.sort(function (item1, item2) {
    return item1.price - item2.price;
    }
);
console.log(sortFromMinPrice);